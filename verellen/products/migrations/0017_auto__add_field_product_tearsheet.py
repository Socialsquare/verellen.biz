...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.tearsheet'
        db.add_column(u'products_product', 'tearsheet',
                      self.gf('django.db.models.fields.files.FileField')(default='no_image.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.tearsheet'
        db.delete_column(u'products_product', 'tearsheet')
