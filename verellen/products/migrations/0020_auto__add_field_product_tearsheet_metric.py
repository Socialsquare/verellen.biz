...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.tearsheet_metric'
        db.add_column(u'products_product', 'tearsheet_metric',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.tearsheet_metric'
        db.delete_column(u'products_product', 'tearsheet_metric')
