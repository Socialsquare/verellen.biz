...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Retailer.country'
        db.add_column(u'retailers_retailer', 'country',
                      self.gf('django.db.models.fields.CharField')(default='USA', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Retailer.country'
        db.delete_column(u'retailers_retailer', 'country')
