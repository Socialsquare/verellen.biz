...
urlpatterns = [
    ...
    # Used to be in partner section but re-reouted because now publicly visible
    url(r'^resources$', partner_views.sales_tools, name='partner.sales_tools'),
    url(r'^products$', partner_views.product_category_list, name='partner.product_category_list'),
    url(r'^products/(?P<category_slug>.*)$', partner_views.product_category, name='partner.product_category'),
    url(r'^product/(?P<product_id>.*)$', partner_views.product_detail, name='partner.product_detail'),
    url(r'^search/$', partner_views.search, name='partner.search'),
    url(r'^view$', partner_views.view_spreadsheet, name='partner.view_spreadsheet'),
